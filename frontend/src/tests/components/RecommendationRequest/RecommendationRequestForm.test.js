...
describe("RecommendationRequestForm tests", () => {
    ...
    test("No Error messsages on good input", async () => {
        ...
        fireEvent.change(professorEmailField, { target: { value: 'example2@ucsb.edu' } });
        fireEvent.change(explanationField, { target: { value: 'Example explanation' } });
        fireEvent.change(dateRequestedField, { target: { value: '2022-01-02T12:00' } });
        fireEvent.change(dateNeededField, { target: { value: '2022-01-02T12:01' } });
